...
// These are rather for informational purpose as the `{}` placeholdes are not completed dynamically and
// a different value will break the completion. Should be useful anyway though.
//    cat api.github.com.json | jq '.paths | keys[]' | sed -e 's_/__' -e 's/$/,/'
func ActionApiV3Paths() carapace.Action {
